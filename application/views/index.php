                        ...
                        <div class="col-xl-4 col-md-12">
                            <div class="card quater-card">
                                <div class="card-block">
                                    ...
                                    <h5>87</h5>
                                    <p class="text-muted">Online Revenue<span class="f-right">60%</span></p>
                                    <div class="progress"><div class="progress-bar bg-c-blue" style="width: 10%"></div></div>
                                    <h5 class="m-t-15">68</h5>
                                    <p class="text-muted">Offline Revenue<span class="f-right">50%</span></p>
                                    <div class="progress"><div class="progress-bar bg-c-green" style="width: 10%"></div></div>
                                </div>
                            </div>
                        </div>
                        <!--  sale analytics end -->
